export default [
    ...
    },
    {
        ...
        stack: ['C','CLI'],
        link: 'https://standin.com',
        information: "A simple game I made that runs in the terminal for a Computer Science assignment. Utilises C and the data structures of linked lists and arrays in order to create a game where the player explores a grid-like map and encounters enemies. This was the first coding project I had ever undertaken in University, so my knowledge of proper program design was pretty weak. Code available upon request."
    },  
    {
